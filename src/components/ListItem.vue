<template>
  <router-link to="/view" class="cursor-pointer text-black">
    <tr
      class="w-full bg-white rounded-lg flex flex-row p-5 text-black mb-3 items-center"
    >
      <td class="mx-auto">Navajo Enterprises LLC</td>
      <td class="mx-auto">ESG Quantitative Report 2021 Q2</td>
      <td class="mx-auto">
        <svg
          viewBox="0 0 128 128"
          aria-hidden="true"
      ...
      <td class="mx-auto">Mar 21, 2021</td>
      <td class="mx-auto">
        <svg
